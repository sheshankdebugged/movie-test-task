...
import LoginLogout from "./components/loginLogoutBtn";

export default function Home() {
  return (
    <div>
      <div className="bgcolor flex flex-wrap min-h-screen flex-col items-center md:pl-32 md:pr-32 md:pt-20 max-w-1440 m-auto">
        <div className="w-full flex flex-row justify-between ">
          <div className="flex flex-row md:pl-0 pl-5 mymovie">
            <div className="flex flex-row button md:btn-wide text-white text-3xl md:text-5xl font-semibold font-semibold	leading-10">
              My movies
            </div>
            <Link href={"/add-new-movie"} className="md:mt-3 mt-1">
